      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-8">
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-light leading-[1.1] text-gray-900">
            ...
            <div className="w-12 h-1 bg-meeru-orange rounded-full" />
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden bg-gray-900 shadow-2xl aspect-video">
              <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                <div className="text-center space-y-4">
                  <button
                    className="w-16 h-16 rounded-full bg-meeru-orange flex items-center justify-center shadow-lg hover:scale-105 transition-transform mx-auto"
